...
static const Stage stages[] = {
    ...
    },
    {
        ...
        "ミルファ湖 レイクダイビング桟橋",
        "観光客でにぎわったレイクダイビング桟橋は水音だけを残して沈黙していた。チャトフィッシュが消えた湖面から、左右のホーム段を同時に試す影が現れた。",
        ...
        3,
        4,
        "湖底に細い水路が開き、古いダイビング小屋の浮標がひとつ灯った。チャトフィッシュの姿はまだないが、小さな泡が王都の方角へ流れ、左右のホーム段をつないだ感覚が次の上段へ伸びる道を示している。",
        "",
        "",
        0
    },
    {
        ...
        "クムの森の入口",
        "クム酒の原料になるクムの木は、灰色の石になって風を忘れていた。足元には石化したクムの実が転がり、左上段の魔術師が枝先から課題をばらまいた。",
        "上段 左手: q / w / e / r / t",
        "q / w / e / r / t",
        ...
        3,
        4,
        "石の枝に小さな緑が戻り、クムの実の殻からかすかな香りが立った。王立クムの木研究所の古い標識が倒れており、左手の上段に触れた文字の欠片が右側の森へ続く道を示している。",
        "",
        "",
        0
    },
    ...
    },
    {
        ...
        "王立クムの木研究所 地下書庫",
        "タマオ博士の研究記録が眠る地下書庫には、石化したクムの木の標本と特殊細胞の図が並んでいた。左下段の幻は、左手を下へ沈める課題で封印を守っている。",
        "下段 左手: z / x / c / v / b",
        "z / x / c / v / b",
        ...
        4,
        6,
        "封印の一枚が剥がれ、左下段の感覚が戻った。タマオ博士の走り書きには、クムの木の細胞反応とドリームポイントの名が並んでいる。古文書の奥には、右下段の記号を示す古い図が残されていた。",
        "",
        "",
        0
    },
    ...
    },
    {
        ...
        "通信塔 ビッグハンド門",
        "塔の最上階へ続く巨大な手の門で、英字、数字、記号が剣の形に並ぶ。総合の門番は、これまで覚えた打鍵を混ぜて求めてきた。",
        "総合練習: Shift記号と混合課題",
        ...
        4,
        7,
        "ビッグハンド門が開き、すべてのキーを使う追加の試練が姿を見せた。ここから先は、記号も括弧も引用符もまとめて読み切らなければならない。",
        "",
        "",
        0
    },
    ...
    },
    {
        ...
        "通信塔 呪文の壁",
        "呪文の壁には、角括弧、波括弧、引用符が並んでいた。括弧の門番は、似た形の記号を見分ける力を求めてくる。",
        "全キー練習: 括弧、引用符、区切り記号",
        "[ / ] / { / } / \" / ' / : / ; / ? / / / \\ / |",
    ...
    },
    {
        ...
        "通信塔最上階",
        "塔の最上階で、抜け落ちたすべてのキーが剣の形に並ぶ。ドリームポイントの影が巨大な手となって現れ、英字、数字、記号、スペースをすべて重ねて求めてきた。",
        "最終練習: 全キー混合課題",
        "全英字 / 数字 / ! @ # $ % ^ & * ( ) _ + = \\ | ] [ } { \" ' : ; ? / / Space",
        ...
        10,
        10,
        "剣はあなたの入力に応え、石化の呪文を一文字ずつ上書きしていく。抜け落ちていたキーはすべて元の場所へ戻り、塔の外で森と湖が同時にざわめき始めた。",
        "",
        "",
        0
    },
