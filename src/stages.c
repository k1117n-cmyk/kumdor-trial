...
static const Stage stages[] = {
    ...
    },
    {
        ...
        "ミルファ湖の沈んだ桟橋",
        "チャトフィッシュが消えたミルファ湖は、湖面だけが静かすぎた。沈んだ桟橋の影から、左右のホーム段を同時に試すものが現れた。",
        ...
        3,
        4,
        "湖底に細い水路が開き、小さな泡が王都の方角へ流れ始めた。チャトフィッシュの姿はまだないが、左右のホーム段をつないだ感覚が次の上段へ伸びる道を示している。",
        "",
        "",
        0
    },
    {
        ...
        "クムの森の入口",
        "クム酒の原料になるクムの木は、灰色の石になって風を忘れていた。左上段の魔術師は左手だけで届く枝先から課題をばらまいた。",
        "上段 左手: q / w / e / r / t",
        "q / w / e / r / t",
        ...
        3,
        4,
        "石の枝に小さな緑が戻った。王立クムの木研究所の古い標識が倒れており、左手の上段に触れた文字の欠片が右側の森へ続く道を示している。",
        "",
        "",
        0
    },
    ...
    },
    {
        ...
        "王立クムの木研究所 地下書庫",
        "タマオ博士の研究記録が眠る地下書庫には、石化したクムの木の標本が並んでいた。左下段の幻は、左手を下へ沈める課題で封印を守っている。",
        "下段 左手: z / x / c / v / b",
        "z / x / c / v / b",
        ...
        4,
        6,
        "封印の一枚が剥がれ、左下段の感覚が戻った。博士の走り書きには、異変の中心にドリームポイントという語がある。古文書の奥には、右下段の記号を示す古い図が残されていた。",
        "",
        "",
        0
    },
